  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <h1 className="font-display text-5xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-bv-primary via-bv-cta to-pink-500 bg-clip-text text-transparent">
          Privacy Policy
        </h1>
        ...
        <div className="space-y-8 text-gray-300">
          <section>
            <h2 className="font-display text-2xl font-bold text-bv-primary mb-4">Introduction</h2>
          ...
          <section>
            <h2 className="font-display text-2xl font-bold text-bv-primary mb-4">Information We Collect</h2>
          ...
          <section>
            <h2 className="font-display text-2xl font-bold text-bv-primary mb-4">How We Use Your Information</h2>
          ...
          <section>
            <h2 className="font-display text-2xl font-bold text-bv-primary mb-4">Sharing Your Information</h2>
            <p className="leading-relaxed">
              We do not sell, trade, or rent your personal information to third parties. We may share your information with:
            </p>
            <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
              <li><strong>Service Providers:</strong> Third-party vendors who perform services on our behalf (e.g., email service providers, analytics providers)</li>
          ...
          <section>
            <h2 className="font-display text-2xl font-bold text-bv-primary mb-4">Cookies and Tracking Technologies</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold text-bv-primary mb-4">Third-Party Links</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold text-bv-primary mb-4">Data Security</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold text-bv-primary mb-4">Your Rights</h2>
          ...
          <section>
            <h2 className="font-display text-2xl font-bold text-bv-primary mb-4">Children's Privacy</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold text-bv-primary mb-4">International Data Transfers</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold text-bv-primary mb-4">Changes to This Privacy Policy</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold text-bv-primary mb-4">Contact Us</h2>
            <p className="leading-relaxed">
            ...
            <div className="mt-4 p-6 bg-gray-800/50 rounded-lg border border-gray-700">
              ...
              <p className="mt-2">Email: <a href="mailto:admin@blockvalley.io" className="text-bv-cta hover:text-pink-400 transition-colors">admin@blockvalley.io</a></p>
              <p className="mt-1">Twitter/X: <a href="https://x.com/blockvalleylabs" target="_blank" rel="noopener noreferrer" className="text-bv-cta hover:text-pink-400 transition-colors">@blockvalleylabs</a></p>
            </div>
          </section>
        </div>
      </div>
