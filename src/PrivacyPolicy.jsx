    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold mb-4">Sharing Your Information</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold mb-4">International Data Transfers</h2>
            <p className="leading-relaxed">
          ...
          <section>
            ...
            <div className="mt-4 p-6 bg-gray-800/50 rounded-lg border border-gray-700">
              <p className="font-semibold">Block Valley (LABS)</p>
