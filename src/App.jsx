...
import { 
  ...
  ArrowRight, Play, Mic, ShieldCheck, ChevronDown, 
  Linkedin, Twitter, Mail
} from 'lucide-react';

// --- Colors & Branding ---
// Derived from the provided logo assets (Pink, Blue, Green gradients)
const theme = {
  colors: {
    pink: '#EC4899',   // Closely matches the logo pink
    blue: '#3B82F6',   // Matches the blue
    green: '#10B981',  // Matches the green
    red: '#EF4444',    // From the banner ribbons
    bg: '#ffffff',
    text: '#111827',
    textLight: '#4B5563',
  }
...
// --- Content Data (Extracted from PDF) ---

const philosophyData = [
  {
    title: "Self-Heating Individuals",
    icon: <Zap className="w-6 h-6 text-pink-500" />,
    desc: "Individuals who generate momentum internally—curiosity, execution energy, and insight—without external forcing."
  },
  {
    title: "Cognition Network",
    icon: <Cpu className="w-6 h-6 text-blue-500" />,
    desc: "The collective intelligence formed when experts, operators, creators, and AI agents collaborate."
  },
  {
    title: "Tech x Humanity Party",
    icon: <Users className="w-6 h-6 text-green-500" />,
    desc: "A cultural ethos where technology accelerates, not replaces, human spirit, meaning, creativity, and connection."
  },
  {
...
const servicesData = [
  {
    title: "RWA & DeFi Architecture",
    desc: "Designing multi-jurisdiction structuring, tokenization frameworks, and enterprise stablecoins.",
    color: "bg-blue-50"
  },
  {
    title: "ValleyCast Influence",
    desc: "Our global influence engine. Narratives on AI, Web3, Global Macro Shifts, and East-West bridges.",
    color: "bg-pink-50"
  },
  {
    title: "Enterprise Advisory",
    desc: "Guiding enterprises into Web3. Merging human insight with machine intelligence for global scaling.",
    color: "bg-green-50"
  }
];
        ...
        <div className="hidden md:flex space-x-8">
          {['Identity', 'Philosophy', 'ValleyCast', 'Team', 'Contact'].map((item) => (
            <button 
              ...
              className="text-gray-800 font-medium hover:text-pink-600 transition-colors relative group"
            >
              {item}
...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-white">
      {/* Background Ribbons - Abstract representation of frame-16.jpg */}
      ...
      <div className="absolute bottom-20 left-[-10%] w-96 h-96 bg-pink-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
      ...
      <div className="container mx-auto px-6 z-10 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="px-8 py-4 bg-black text-white rounded-full font-bold hover:bg-gray-800 transition-transform transform hover:scale-105 flex items-center justify-center">
              Our Vision <ArrowRight className="ml-2 w-5 h-5" />
            </button>
            <button className="px-8 py-4 bg-white text-black border-2 border-black rounded-full font-bold hover:bg-gray-50 transition-transform transform hover:scale-105">
              Explore Services
            </button>
          </div>
        </div>
        ...
        <div className="relative">
          <div className="aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl transform rotate-2 hover:rotate-0 transition-all duration-700 bg-gray-100">
            ...
            <video autoPlay muted loop className="w-full h-full object-cover">
              <source src="/media/BlockValleyVideo.mp4" type="video/mp4" />
    ...
    <section id="identity" className="py-24 bg-gray-50 relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-blue-500 hover:-translate-y-2 transition-transform duration-300">
           ...
           {/* Card 2 */}
           <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-pink-500 hover:-translate-y-2 transition-transform duration-300">
           ...
           {/* Card 3 */}
           <div className="bg-white p-8 rounded-2xl shadow-lg border-b-4 border-green-500 hover:-translate-y-2 transition-transform duration-300">
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16">
          ...
          <div className="mt-6 md:mt-0">
            <p className="text-gray-500 text-lg">Hover to decode our language.</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {philosophyData.map((item, index) => (
            <div 
              key={index} 
              className="group relative h-64 bg-gray-50 rounded-2xl p-8 overflow-hidden transition-all duration-300 hover:shadow-xl hover:bg-white border border-transparent hover:border-gray-200"
            >
              <div className="absolute top-8 left-8 transition-all duration-300 group-hover:scale-110">
                {item.icon}
              </div>
              
              <div className="h-full flex flex-col justify-end">
                <h3 className="text-2xl font-bold text-gray-900 transition-all duration-300 group-hover:opacity-0">{item.title}</h3>
              </div>

              <div className="absolute inset-0 p-8 flex items-center justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100 bg-white/95 backdrop-blur-sm">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/2">
            ...
            <a 
              href="https://x.com/i/broadcasts/1vAxRQbqYyzJl" 
              target="_blank" 
              rel="noopener noreferrer"
              className="bg-white text-black px-8 py-4 rounded-full font-bold hover:bg-gray-200 transition-colors inline-flex items-center"
            >
              Listen Now
            </a>
          </div>
          ...
          <div className="lg:w-1/2 relative">
            ...
            <div className="relative z-10 bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-1 border border-gray-700 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
               <div className="bg-black rounded-2xl overflow-hidden aspect-video relative flex items-center justify-center group cursor-pointer">
                  <img src="/media/VALLEYCAST8AM2.png" alt="ValleyCast Latest Episode" className="w-full h-full object-cover" />
               </div>
               <div className="p-6">
      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            <img src="/media/BlockValley_Logo_FullText.png" alt="Block Valley Full Logo" className="h-12 w-auto mb-6" />
            ...
            <div className="flex space-x-4">
               <a href="https://x.com/TheBlockValley" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-black text-white flex items-center justify-center hover:bg-gray-800 transition-colors">
                 <Twitter size={18} />
               </a>
               <a href="mailto:djkenjiflow@gmail.com" className="w-10 h-10 rounded-full bg-pink-500 text-white flex items-center justify-center hover:bg-pink-600 transition-colors">
                 <Mail size={18} />
               </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-600">
              <li><a href="#" className="hover:text-pink-600 transition-colors">Work With Us</a></li>
              <li><a href="#" className="hover:text-pink-600 transition-colors">ValleyCast Episodes</a></li>
              <li><a href="#" className="hover:text-pink-600 transition-colors">RWA Research</a></li>
